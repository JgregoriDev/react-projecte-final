        ...
        <div className="col-12 col-lg-8">
          ...
          <div className='mb-3'>
            <Button
              ...
              aria-expanded={open4}
            >
                Vull un videojoc On aconseguir-lo?
            </Button>
            <Collapse className='my-4' in={open4}>
              <div id="example-collapse-text">


                Troba el teu producte a través del cercador de la nostra pàgina web. Tecleja el titol del videojoc o el codi de barres si el coneixes,
                 i accediràs a tots els videojocs que compleixen les condicions de la teua cerca.

                Selecciona l'article i accedeix a la fitxa completa on podràs comprovar les possibles opcions de compra. 
                Afig-ho a la cistella i tria la que més et convinga o compra-ho directament si vullgueres només aquest joc.

                  
              </div>
            </Collapse>
          </div>
          <div className="d-flex flex-column flex-lg-row gap-lg-2 justify-content-between">
            <div className=' d-flex target my-2 flex-column justify-content-center'>
              <div className='mb-1'>
            ...
            <div className='d-flex target my-2 flex-column gap-1 justify-content-center'>
              <div className='mb-1'>
                Teléfon: <a href="tel:+34 6### ### ###">+34 6## ### ###</a>
              </div>
